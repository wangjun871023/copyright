/*
		课程管理窗口
*/
Ext.define('MyDesktop.admin.CourseManagerWindow', {
    ...
    id:'course-manager-win',
    init : function(){
        this.launcher = {
            text: courseManagerWindowTitleStr,
            iconCls:'icon-grid'
        };
    },
    createWindow : function(){
        var desktop = this.app.getDesktop();
        var win = desktop.getWindow('course-manager-win');
        if(!win){
            win = desktop.createWindow({
                id: 'course-manager-win',
                title:courseManagerWindowTitleStr,
                width:courseManagerWindowWidth,
                height:courseManagerWindowHeight,
                iconCls: 'icon-grid',
                animCollapse:false,
                constrain : true,
                layout: 'fit',
