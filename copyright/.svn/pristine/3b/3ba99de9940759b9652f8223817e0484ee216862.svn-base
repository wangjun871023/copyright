/*
		课头学生信息管理窗口
*/
Ext.define('MyDesktop.admin.StudentManagerWindow', {
    ...
    createWindow : function(){
        ...
        var win = desktop.getWindow('student-manager-win');
        if(!win){
            win = desktop.createWindow({
                id:'student-manager-win',
                title:studentManagerWindowTitleStr,
                width:studentManagerWindowWidth,
                height:studentManagerWindowHeight,
                iconCls: 'icon-grid',
                animCollapse:false,
                ...
                items: [{
					...
					items:[{
						...
						split: true,  
						store:Ext.create('MyDesktop.store.TeacherClassHeadStore'),
						region:'west',
